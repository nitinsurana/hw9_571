...
public class BillFragment extends Fragment {
    ...
    private LegislatorFragment.OnFragmentInteractionListener mListener;
...
//    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof LegislatorFragment.OnFragmentInteractionListener) {
            mListener = (LegislatorFragment.OnFragmentInteractionListener) context;
        } else {
